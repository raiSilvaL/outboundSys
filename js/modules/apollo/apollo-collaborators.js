/**
 * Módulo de Auditorias Apollo por Colaborador
 */
...
let collaboratorFiltersInitialized = false;

function initializeCollaboratorFilters() {
    if (collaboratorFiltersInitialized) {
        // Filtros e listeners já vinculados; apenas garantir que as opções estejam populadas
        populateCollaboratorOptions();
        return;
    }
    collaboratorFiltersInitialized = true;
